...
const ShareModal = ({ open, onOpenChange }: ShareModalProps) => {
  ...
  const shareToSocial = (platform: string) => {
    ...
    const text = encodeURIComponent("Dashboard Pangan Kabupaten Ciamis");
      ...
      <DialogContent className="max-w-md w-full p-0">
        <DialogHeader className="p-6 pb-4 border-b">
          <div className="flex items-center justify-between">
            <DialogTitle className="text-lg font-semibold">Bagikan</DialogTitle>
            <Button
              variant="ghost"
              size="icon"
        ...
        <div className="p-6 pt-4">
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              <Input value={pageLink} readOnly className="flex-1 bg-muted" />
              <Button
                variant="outline"
                size="icon"
          ...
          <div>
            ...
            <div className="flex items-start gap-2 text-xs text-muted-foreground">
              ...
              <span>
                Terkendala melakukan embed script? Hubungi tim Dashboard Simanis
              </span>
            </div>
          </div>
        </div>
